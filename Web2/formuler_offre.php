		...
		<div class="container">
			...
			$(document).ready(function()
			{
			    $("#form-signin").submit(function()
			    {
			        ...
			        var onche = JSON.parse(postData);
			        if(JSON.parse(postData).domaine != null)
					{
			        console.log(onche);
			        if (onche.boolType == 'false')
			        {
			            onche.prix = 0;
			        }
			        //console.log("test salope");
			        var charlie = JSON.stringify(onche);
			        //console.log(charlie);
			        $.ajax(
			        {
			            type: "POST",	
			            url: "v1/api/offres.php",
			            data: charlie,
			...
			<div id="green-box" class="alert alert-success" hidden>
					Votre offre est maintenant en ligne!
			</div>
			<form id="form-signin" class="form-signin">
				<!-- Entrées Titre de l'offre -->
				<div class="input-group"> <span class="input-group-addon" id="basic-addon1">Titre de l'offre</span>	
					<input type="text" name="titre" class="form-control" placeholder="Exemple : refaire une toiture" aria-describedby="basic-addon1">
				</div>
				<br>
				...
				<div class="form-group">
					...
					<div class="col-xs-5 selectContainer">
						<select name="boolType" class="form-control" name="type_demande">
					...
					<div class="form-group">
						...
						<textarea name="description" class="form-control" rows="2" id="description" required></textarea>
					</div>
				</div>
				<!-- Entrées du prix -->
				<div class="form-group">
				...
				<!-- Entrées Departement -->
				<div class="form-group">
					<label class="col-xs-3 control-label">Département</label>
					<div class="col-xs-5 selectContainer">
