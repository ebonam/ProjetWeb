...
function chkcontrol(j,max)
    {
        ...
        t = get_checkboxes();
        if (t.length > max) {
            alert("Domaines maximum atteind.");
            list.checked = false ;
        }
...
function get_checkboxes() {
  ...
  <body>
    ...
    <div class="container">
     ...
     <form name="form1" method="post" class="form-signin" action="Consulter.php" >
        ...
        <div class="col-xs-5 selectContainer">
            <select name="type" class="form-control" name="type_demande">
                <option value="true">Offres</option>
                <option value="false">Demandes</option>	
            </select>
        </div>
		<br>
		<br>
		<br>
		<div class="input-group">
			<span class="input-group-addon" id="sizing-addon2">Prix maximum</span>
			<input name="prixmax" type="text" class="form-control" placeholder="nombre(s) point(s)" aria-describedby="sizing-addon2" required autofocus>
		</div>
		<br>
		
		<div class="input-group">
			<span class="input-group-addon" id="sizing-addon2">Domaine(s)&nbsp;&nbsp;&nbsp;<br>(5 max)&nbsp;&nbsp;</span>
			...
			$uri = "http://127.0.0.1/API/V1/domaines.php";
			$array = array(
					"domaines" => "tous",
			);
			...
			echo <<<EOF
				<div class="row">
					<div class="col-sm-4 col-md-4">
							<div class="radio">
								<label><input  type="checkbox" name="domaine[]" value="$nom[$i]" id=$i onclick='chkcontrol($i,5)'>&nbsp;{$nom[$i]}</label>
							</div>
					</div>
EOF;
				$i= $i+1;
