...
$app->ajoutUtilisateur($_POST['login'], $_POST['mdp'], $_POST['mail'], $_POST['nom'], $_POST['ville'], $_POST['dep']);
$nom = $_POST['nom'];
...
<button class="btn btn-lg btn-primary btn-block" type="submit">Retour à l'acceuil</button>
</form>
